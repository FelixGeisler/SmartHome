...
describe('draftToInput', () => {
  ...
  it('maps a command action, sending only the attributes that are set', () => {
    ...
    draft.name = 'Warm up'
    draft.trigger = { deviceId: '10', sensorKey: 'temperature', comparison: 'LESS_THAN', threshold: '18' }
    draft.actions = [
...
describe('draftError', () => {
  function validDraft() {
    const draft = emptyDraft()
    draft.name = 'Vent'
    draft.trigger = { deviceId: '10', sensorKey: 'temperature', comparison: 'GREATER_THAN', threshold: '25' }
