...
// @DataJpaTest's slice doesn't include Flyway, so pull it in to run the real migrations against the
// test database; the repository is then exercised on the same schema the application uses.
@DataJpaTest
